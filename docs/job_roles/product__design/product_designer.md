...
* **Visual Designer:** Specializes in iconography, typography, illustration, and the overall "look and feel" of the product.
* **Interaction Designer:** Focuses on motion, animation, and the behavioral aspects of the interface.
* **Growth Designer:** Focuses on optimizing conversion funnels, onboarding flows, and viral loops to drive user acquisition and retention.

## Average Daily Tasks
* 10:00 Critique
* 11:00 Figma
* 14:00 Usability testing
...
* **[storybook](https://storybook.js.org/)**: Used for developing and documenting UI components in isolation.
* **[google-drive](https://www.google.com/drive/)**: Used for storing and sharing documents and assets.


## Recommended Reading

*   **[Interview Preparation Guide](../../interview_questions/product__design/product_designer.md)**: Comprehensive questions and answers for this role.
