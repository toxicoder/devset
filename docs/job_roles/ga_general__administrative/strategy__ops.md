...
* "I've mapped out the current state process flow; here is where the friction is."
* "We need to define the decision-making framework for this project."
* "Let's automate this report; we are spending too much time copying and pasting."
* "I'm preparing the pre-read for the offsite; please update your slides by EOD."
* "Who is the DRI for this key result? We need clear accountability."
* "The data suggests we are missing our target; let's deep dive into the root cause."
* "We need to standardize our onboarding process across all departments."
* "I'm facilitating a retrospective to learn from the failures of last quarter."
* "Let's create a playbook for entering new markets."
* "This meeting has no agenda; I'm canceling it to give you time back."
* "We need to balance speed with quality; let's not rush the planning phase."
* "I've synthesized the feedback from the employee survey; here are the top three action items."
...
*   **[Interview Preparation Guide](../../interview_questions/ga_general__administrative/strategy__ops.md)**: Comprehensive questions and answers for this role.
